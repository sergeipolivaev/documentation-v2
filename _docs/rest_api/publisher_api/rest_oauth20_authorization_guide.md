...
* Query-параметр `type` указывает тип клиента. Типы клиентов различаются доступными типами авторизации. Возможные значения:
...
Возвращает список с данным всех клиентов приложения. Параметр `version-id` содержит версию приложения, заданную на сайте разработчиков.
