...
{% include note.html content="Распространение событий подписки не зависит от факта регистрации (авторизации) пользователя в стороннем сервисе или [передачи токена Облака Эвотор](./doc_authorization.html#automated)." %}
